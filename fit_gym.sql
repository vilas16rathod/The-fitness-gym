<!DOCTYPE html>
<!-- saved from url=(0048)http://localhost/phpmyadmin/server_databases.php -->
<html lang="en" dir="ltr"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link rel="shortcut icon" href="http://localhost/phpmyadmin/favicon.ico" type="image/x-icon">
      <link rel="stylesheet" type="text/css" href="./fit_gym_files/jquery-ui.css">
    <link rel="stylesheet" type="text/css" href="./fit_gym_files/codemirror.css">
    <link rel="stylesheet" type="text/css" href="./fit_gym_files/show-hint.css">
    <link rel="stylesheet" type="text/css" href="./fit_gym_files/lint.css">
    <link rel="stylesheet" type="text/css" href="./fit_gym_files/theme.css">
    <link rel="stylesheet" type="text/css" href="./fit_gym_files/printview.css" media="print" id="printcss">
    <title>localhost / 127.0.0.1:3307 | phpMyAdmin 5.0.3</title>
    <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/jquery.min.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/jquery-migrate.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/whitelist.php"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/sprintf.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/ajax.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/keyhandler.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/bootstrap.bundle.min.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/jquery-ui.min.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/js.cookie.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/jquery.mousewheel.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/jquery.event.drag-2.2.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/jquery.validate.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/jquery-ui-timepicker-addon.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/jquery.ba-hashchange-1.3.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/jquery.debounce-1.0.5.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/menu_resizer.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/cross_framing_protection.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/rte.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/tracekit.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/error_report.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/messages.php"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/config.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/doclinks.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/functions.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/navigation.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/indexes.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/common.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/page_settings.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/drag_drop_import.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/shortcuts_handler.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/codemirror.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/sql.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/runmode.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/show-hint.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/sql-hint.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/lint.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/sql-lint.js.download"></script>
  <script data-cfasync="false" type="text/javascript" src="./fit_gym_files/console.js.download"></script>

<script data-cfasync="false" type="text/javascript">
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"db_structure.php",lang:"en",server:"1",table:"",db:"",token:"7e525c2f52724971472a556e3e27375f",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",PMA_VERSION:"5.0.3",auth_type:"config",user:"root"});
...
<script type="text/javascript" src="./fit_gym_files/databases.js.download"></script><script type="text/javascript" src="./fit_gym_files/structure.js.download"></script><script type="text/javascript" src="./fit_gym_files/change.js.download"></script><script type="text/javascript" src="./fit_gym_files/makegrid.js.download"></script><script type="text/javascript" src="./fit_gym_files/jquery.uitablefilter.js.download"></script><script type="text/javascript" src="./fit_gym_files/stickyfill.min.js.download"></script><script type="text/javascript" src="./fit_gym_files/sql.js(1).download"></script></head>
<body style="margin-left: 240px; margin-bottom: 21.0938px; padding-top: 60.5625px;">
        ...
        <a class="hide navigation_url" href="http://localhost/phpmyadmin/navigation.php?ajax_request=1"></a>
                  ...
                  <div id="pmalogo">
                          <a href="http://localhost/phpmyadmin/index.php">
                                      <img id="imgpmalogo" src="./fit_gym_files/logo_left.png" alt="phpMyAdmin">
                                      </a>
                      </div>
        
        <div id="navipanellinks">
          <a href="http://localhost/phpmyadmin/index.php" title="Home"><img src="./fit_gym_files/dot.gif" title="Home" alt="Home" class="icon ic_b_home"></a>

                      <a class="logout disableAjax" href="http://localhost/phpmyadmin/logout.php" title="Empty session data"><img src="./fit_gym_files/dot.gif" title="Empty session data" alt="Empty session data" class="icon ic_s_loggoff"></a>
          
          <a href="http://localhost/phpmyadmin/doc/html/index.html" title="phpMyAdmin documentation" target="_blank" rel="noopener"><img src="./fit_gym_files/dot.gif" title="phpMyAdmin documentation" alt="phpMyAdmin documentation" class="icon ic_b_docs"></a>

          <a href="http://localhost/phpmyadmin/url.php?url=https%3A%2F%2Fdev.mysql.com%2Fdoc%2Frefman%2F5.7%2Fen%2Findex.html" title="Documentation" target="_blank" rel="noopener noreferrer"><img src="./fit_gym_files/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_sqlhelp"></a>

          <a id="pma_navigation_settings_icon" href="http://localhost/phpmyadmin/server_databases.php#" title="Navigation panel settings"><img src="./fit_gym_files/dot.gif" title="Navigation panel settings" alt="Navigation panel settings" class="icon ic_s_cog"></a>

          <a id="pma_navigation_reload" href="http://localhost/phpmyadmin/server_databases.php#" title="Reload navigation panel"><img src="./fit_gym_files/dot.gif" title="Reload navigation panel" alt="Reload navigation panel" class="icon ic_s_reload"></a>
        </div>

        
        <img src="./fit_gym_files/dot.gif" title="Loading…" alt="Loading…" style="visibility: hidden; display:none" class="icon ic_ajax_clock_small throbber">
      </div>
      <div id="pma_navigation_tree" class="list_container synced highlight autoexpand" style="height: 543px;">
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="http://localhost/phpmyadmin/tbl_recent_favorite.php?db=fit_gym&amp;table=memberregister_tb">`fit_gym`.`memberregister_tb`</a></li><li class="warp_link"><a href="http://localhost/phpmyadmin/tbl_recent_favorite.php?db=fit_gym&amp;table=trainerregister_tb">`fit_gym`.`trainerregister_tb`</a></li><li class="warp_link"><a href="http://localhost/phpmyadmin/tbl_recent_favorite.php?db=loginsystem&amp;table=logintb">`loginsystem`.`logintb`</a></li><li class="warp_link"><a href="http://localhost/phpmyadmin/tbl_recent_favorite.php?db=loginsystem&amp;table=payment">`loginsystem`.`payment`</a></li><li class="warp_link"><a href="http://localhost/phpmyadmin/tbl_recent_favorite.php?db=loginsystem&amp;table=trainer">`loginsystem`.`trainer`</a></li><li class="warp_link"><a href="http://localhost/phpmyadmin/tbl_recent_favorite.php?db=loginsystem&amp;table=package">`loginsystem`.`package`</a></li><li class="warp_link"><a href="http://localhost/phpmyadmin/tbl_recent_favorite.php?db=loginsystem&amp;table=doctorapp">`loginsystem`.`doctorapp`</a></li><li class="warp_link"><a href="http://localhost/phpmyadmin/tbl_recent_favorite.php?db=fit_gym&amp;table=contact_tb">`fit_gym`.`contact_tb`</a></li><li class="warp_link"><a href="http://localhost/phpmyadmin/tbl_recent_favorite.php?db=fitgym&amp;table=tbladmin">`fitgym`.`tbladmin`</a></li><li class="warp_link"><a href="http://localhost/phpmyadmin/tbl_recent_favorite.php?db=fitness&amp;table=usertable">`fitness`.`usertable`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>

<div class="clearfloat"></div>

<ul>
  
  <!-- CONTROLS START --><li id="navigation_controls_outer" class=""><div id="navigation_controls"><a href="http://localhost/phpmyadmin/server_databases.php#" id="pma_navigation_collapse" title="Collapse all"><img src="./fit_gym_files/dot.gif" title="Collapse all" alt="Collapse all" class="icon ic_s_collapseall"></a><a href="http://localhost/phpmyadmin/server_databases.php#" id="pma_navigation_sync" title="Unlink from main panel"><img src="./fit_gym_files/dot.gif" title="Unlink from main panel" alt="Unlink from main panel" class="icon ic_s_link"></a></div></li><!-- CONTROLS ENDS -->
</ul>
...
<div id="pma_navigation_tree_content" style="height: 488.156px;">
  <ul>
    <li class="first new_database italics"><div class="block"><i class="first"></i></div><div class="block "><a href="http://localhost/phpmyadmin/server_databases.php?server=1"><img src="./fit_gym_files/dot.gif" title="" alt="" class="icon ic_b_newdb"></a></div><a class="hover_show_full" href="http://localhost/phpmyadmin/server_databases.php?server=1" title="New">New</a><div class="clearfloat"></div></li><li class="database"><div class="block"><i></i><b></b><a class="expander loaded" href="http://localhost/phpmyadmin/server_databases.php#"><span class="hide aPath">cm9vdA==.Zml0X2d5bQ==</span><span class="hide vPath">cm9vdA==.Zml0X2d5bQ==</span><span class="hide pos">0</span><img src="./fit_gym_files/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_minus" style=""></a></div><div class="block "><a href="http://localhost/phpmyadmin/db_operations.php?server=1&amp;db=fit_gym&amp;"><img src="./fit_gym_files/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class="hover_show_full" href="http://localhost/phpmyadmin/db_structure.php?server=1&amp;db=fit_gym" title="Structure">fit_gym</a><div class="clearfloat"></div>
  <div class="list_container hide" style="display: block;">
  <ul>
    <li class="new_table italics"><div class="block"><i></i><span class="hide pos2_name">tables</span><span class="hide pos2_value">0</span></div><div class="block "><a href="http://localhost/phpmyadmin/tbl_create.php?server=1&amp;db=fit_gym"><img src="./fit_gym_files/dot.gif" title="New" alt="New" class="icon ic_b_table_add"></a></div><a class="hover_show_full" href="http://localhost/phpmyadmin/tbl_create.php?server=1&amp;db=fit_gym" title="New">New</a><div class="clearfloat"></div></li><li class="table"><div class="block"><i></i><b></b><a class="expander" href="http://localhost/phpmyadmin/server_databases.php#"><span class="hide aPath">cm9vdA==.Zml0X2d5bQ==.dGFibGVz.Y29udGFjdF90Yg==</span><span class="hide vPath">cm9vdA==.Zml0X2d5bQ==.VGFibGVz.Y29udGFjdF90Yg==</span><span class="hide pos">0</span><span class="hide pos2_name">tables</span><span class="hide pos2_value">0</span><img src="./fit_gym_files/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block "><a href="http://localhost/phpmyadmin/tbl_structure.php?server=1&amp;db=fit_gym&amp;table=contact_tb"><img src="./fit_gym_files/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props"></a></div><a class="hover_show_full" href="http://localhost/phpmyadmin/sql.php?server=1&amp;db=fit_gym&amp;table=contact_tb&amp;pos=0" title="Browse">contact_tb</a><span class="navItemControls"><a href="http://localhost/phpmyadmin/navigation.php" data-post="hideNavItem=1&amp;itemType=table&amp;itemName=contact_tb&amp;dbName=fit_gym" class="hideNavItem ajax"><img src="./fit_gym_files/dot.gif" title="Hide" alt="Hide" class="icon ic_hide"></a></span><div class="clearfloat"></div></li><li class="table"><div class="block"><i></i><b></b><a class="expander" href="http://localhost/phpmyadmin/server_databases.php#"><span class="hide aPath">cm9vdA==.Zml0X2d5bQ==.dGFibGVz.bWVtYmVycmVnaXN0ZXJfdGI=</span><span class="hide vPath">cm9vdA==.Zml0X2d5bQ==.VGFibGVz.bWVtYmVycmVnaXN0ZXJfdGI=</span><span class="hide pos">0</span><span class="hide pos2_name">tables</span><span class="hide pos2_value">0</span><img src="./fit_gym_files/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block "><a href="http://localhost/phpmyadmin/tbl_structure.php?server=1&amp;db=fit_gym&amp;table=memberregister_tb"><img src="./fit_gym_files/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props"></a></div><a class="hover_show_full" href="http://localhost/phpmyadmin/sql.php?server=1&amp;db=fit_gym&amp;table=memberregister_tb&amp;pos=0" title="Browse">memberregister_tb</a><span class="navItemControls"><a href="http://localhost/phpmyadmin/navigation.php" data-post="hideNavItem=1&amp;itemType=table&amp;itemName=memberregister_tb&amp;dbName=fit_gym" class="hideNavItem ajax"><img src="./fit_gym_files/dot.gif" title="Hide" alt="Hide" class="icon ic_hide"></a></span><div class="clearfloat"></div></li><li class="last table"><div class="block"><i></i><a class="expander" href="http://localhost/phpmyadmin/server_databases.php#"><span class="hide aPath">cm9vdA==.Zml0X2d5bQ==.dGFibGVz.dHJhaW5lcnJlZ2lzdGVyX3Ri</span><span class="hide vPath">cm9vdA==.Zml0X2d5bQ==.VGFibGVz.dHJhaW5lcnJlZ2lzdGVyX3Ri</span><span class="hide pos">0</span><span class="hide pos2_name">tables</span><span class="hide pos2_value">0</span><img src="./fit_gym_files/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block "><a href="http://localhost/phpmyadmin/tbl_structure.php?server=1&amp;db=fit_gym&amp;table=trainerregister_tb"><img src="./fit_gym_files/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props"></a></div><a class="hover_show_full" href="http://localhost/phpmyadmin/sql.php?server=1&amp;db=fit_gym&amp;table=trainerregister_tb&amp;pos=0" title="Browse">trainerregister_tb</a><span class="navItemControls"><a href="http://localhost/phpmyadmin/navigation.php" data-post="hideNavItem=1&amp;itemType=table&amp;itemName=trainerregister_tb&amp;dbName=fit_gym" class="hideNavItem ajax"><img src="./fit_gym_files/dot.gif" title="Hide" alt="Hide" class="icon ic_hide"></a></span><div class="clearfloat"></div></li>
  </ul>

  </div>


</li><li class="database"><div class="block"><i></i><b></b><a class="expander" href="http://localhost/phpmyadmin/server_databases.php#"><span class="hide aPath">cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h</span><span class="hide vPath">cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h</span><span class="hide pos">0</span><img src="./fit_gym_files/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block "><a href="http://localhost/phpmyadmin/db_operations.php?server=1&amp;db=information_schema&amp;"><img src="./fit_gym_files/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class="hover_show_full" href="http://localhost/phpmyadmin/db_structure.php?server=1&amp;db=information_schema" title="Structure">information_schema</a><div class="clearfloat"></div></li><li class="database"><div class="block"><i></i><b></b><a class="expander" href="http://localhost/phpmyadmin/server_databases.php#"><span class="hide aPath">cm9vdA==.bG9naW5zeXN0ZW0=</span><span class="hide vPath">cm9vdA==.bG9naW5zeXN0ZW0=</span><span class="hide pos">0</span><img src="./fit_gym_files/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block "><a href="http://localhost/phpmyadmin/db_operations.php?server=1&amp;db=loginsystem&amp;"><img src="./fit_gym_files/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class="hover_show_full" href="http://localhost/phpmyadmin/db_structure.php?server=1&amp;db=loginsystem" title="Structure">loginsystem</a><div class="clearfloat"></div></li><li class="database"><div class="block"><i></i><b></b><a class="expander" href="http://localhost/phpmyadmin/server_databases.php#"><span class="hide aPath">cm9vdA==.bXlzcWw=</span><span class="hide vPath">cm9vdA==.bXlzcWw=</span><span class="hide pos">0</span><img src="./fit_gym_files/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block "><a href="http://localhost/phpmyadmin/db_operations.php?server=1&amp;db=mysql&amp;"><img src="./fit_gym_files/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class="hover_show_full" href="http://localhost/phpmyadmin/db_structure.php?server=1&amp;db=mysql" title="Structure">mysql</a><div class="clearfloat"></div></li><li class="database"><div class="block"><i></i><b></b><a class="expander" href="http://localhost/phpmyadmin/server_databases.php#"><span class="hide aPath">cm9vdA==.b3Ntc19kYg==</span><span class="hide vPath">cm9vdA==.b3Ntc19kYg==</span><span class="hide pos">0</span><img src="./fit_gym_files/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block "><a href="http://localhost/phpmyadmin/db_operations.php?server=1&amp;db=osms_db&amp;"><img src="./fit_gym_files/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class="hover_show_full" href="http://localhost/phpmyadmin/db_structure.php?server=1&amp;db=osms_db" title="Structure">osms_db</a><div class="clearfloat"></div></li><li class="database"><div class="block"><i></i><b></b><a class="expander" href="http://localhost/phpmyadmin/server_databases.php#"><span class="hide aPath">cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h</span><span class="hide vPath">cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h</span><span class="hide pos">0</span><img src="./fit_gym_files/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block "><a href="http://localhost/phpmyadmin/db_operations.php?server=1&amp;db=performance_schema&amp;"><img src="./fit_gym_files/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class="hover_show_full" href="http://localhost/phpmyadmin/db_structure.php?server=1&amp;db=performance_schema" title="Structure">performance_schema</a><div class="clearfloat"></div></li><li class="database"><div class="block"><i></i><b></b><a class="expander" href="http://localhost/phpmyadmin/server_databases.php#"><span class="hide aPath">cm9vdA==.cGhwbXlhZG1pbg==</span><span class="hide vPath">cm9vdA==.cGhwbXlhZG1pbg==</span><span class="hide pos">0</span><img src="./fit_gym_files/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block "><a href="http://localhost/phpmyadmin/db_operations.php?server=1&amp;db=phpmyadmin&amp;"><img src="./fit_gym_files/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class="hover_show_full" href="http://localhost/phpmyadmin/db_structure.php?server=1&amp;db=phpmyadmin" title="Structure">phpmyadmin</a><div class="clearfloat"></div></li><li class="last database"><div class="block"><i></i><a class="expander" href="http://localhost/phpmyadmin/server_databases.php#"><span class="hide aPath">cm9vdA==.dGVzdA==</span><span class="hide vPath">cm9vdA==.dGVzdA==</span><span class="hide pos">0</span><img src="./fit_gym_files/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block "><a href="http://localhost/phpmyadmin/db_operations.php?server=1&amp;db=test&amp;"><img src="./fit_gym_files/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class="hover_show_full" href="http://localhost/phpmyadmin/db_structure.php?server=1&amp;db=test" title="Structure">test</a><div class="clearfloat"></div></li>
  </ul>
</div>
      ...
      <div id="pma_navi_settings_container">
                  <div id="pma_navigation_settings"><div class="page_settings"><form method="post" action="http://localhost/phpmyadmin/server_databases.php?db=&amp;table=&amp;server=1&amp;target=" class="config-form disableAjax"><input type="hidden" name="tab_hash" value=""><input type="hidden" name="check_page_refresh" id="check_page_refresh" value="1">
<input type="hidden" name="token" value="7e525c2f52724971472a556e3e27375f">
<input type="hidden" name="submit_save" value="Navi"><ul class="tabs responsivetable">

                                    <li class="active">

            <a href="http://localhost/phpmyadmin/server_databases.php#Navi_panel">
            Navigation panel
            </a>
        </li>
                                <li>

            <a href="http://localhost/phpmyadmin/server_databases.php#Navi_tree">
            Navigation tree
            </a>
        </li>
                                <li>

            <a href="http://localhost/phpmyadmin/server_databases.php#Navi_servers">
            Servers
            </a>
        </li>
                                <li>

            <a href="http://localhost/phpmyadmin/server_databases.php#Navi_databases">
            Databases
            </a>
        </li>
                                <li>

            <a href="http://localhost/phpmyadmin/server_databases.php#Navi_tables">
            Tables
            </a>
        </li>
            </ul>
...
if (typeof configScriptLoaded !== "undefined" && configInlineParams) loadInlineConfig();
      ...
      <div id="floating_menubar" style="margin-left: 243px; left: 0px; position: fixed; top: 0px; width: 100%; z-index: 99;"><div id="serverinfo"><img src="./fit_gym_files/dot.gif" title="" alt="" class="icon ic_s_host item"><a href="http://localhost/phpmyadmin/index.php" class="item">Server: 127.0.0.1:3307</a><div class="clearfloat"></div></div><div id="topmenucontainer" class="menucontainer"><i class="scrollindicator scrollindicator--left"><img alt="" title="" src="./fit_gym_files/dot.gif" class="icon ic_b_left"></i><div class="navigationbar" style="width: auto; overflow: visible;"><ul id="topmenu" class="resizable-menu"><li class="active">

            <a href="http://localhost/phpmyadmin/server_databases.php" class="tabactive">
            <img src="./fit_gym_files/dot.gif" title="Databases" alt="Databases" class="icon ic_s_db">&nbsp;Databases
            </a>
        </li>
<li>

            <a href="http://localhost/phpmyadmin/server_sql.php" class="tab">
            <img src="./fit_gym_files/dot.gif" title="SQL" alt="SQL" class="icon ic_b_sql">&nbsp;SQL
            </a>
        </li>
<li>

            <a href="http://localhost/phpmyadmin/server_status.php" class="tab">
            <img src="./fit_gym_files/dot.gif" title="Status" alt="Status" class="icon ic_s_status">&nbsp;Status
            </a>
        </li>
<li>

            <a href="http://localhost/phpmyadmin/server_privileges.php?viewing_mode=server" class="tab">
            <img src="./fit_gym_files/dot.gif" title="User accounts" alt="User accounts" class="icon ic_s_rights">&nbsp;User accounts
            </a>
        </li>
<li>

            <a href="http://localhost/phpmyadmin/server_export.php" class="tab">
            <img src="./fit_gym_files/dot.gif" title="Export" alt="Export" class="icon ic_b_export">&nbsp;Export
            </a>
        </li>
<li>

            <a href="http://localhost/phpmyadmin/server_import.php" class="tab">
            <img src="./fit_gym_files/dot.gif" title="Import" alt="Import" class="icon ic_b_import">&nbsp;Import
            </a>
        </li>
<li>

            <a href="http://localhost/phpmyadmin/prefs_manage.php" class="tab">
            <img src="./fit_gym_files/dot.gif" title="Settings" alt="Settings" class="icon ic_b_tblops">&nbsp;Settings
            </a>
        </li>
<li>

            <a href="http://localhost/phpmyadmin/server_replication.php" class="tab">
            <img src="./fit_gym_files/dot.gif" title="Replication" alt="Replication" class="icon ic_s_replication">&nbsp;Replication
            </a>
        </li>
<li>

            <a href="http://localhost/phpmyadmin/server_variables.php" class="tab">
            <img src="./fit_gym_files/dot.gif" title="Variables" alt="Variables" class="icon ic_s_vars">&nbsp;Variables
            </a>
        </li>
<li>

            <a href="http://localhost/phpmyadmin/server_collations.php" class="tab">
            <img src="./fit_gym_files/dot.gif" title="Charsets" alt="Charsets" class="icon ic_s_asci">&nbsp;Charsets
            </a>
        </li>


<li class="submenu shown" style=""><a href="http://localhost/phpmyadmin/server_databases.php#" class="tab nowrap"><img alt="" title="" src="./fit_gym_files/dot.gif" class="icon ic_b_more">More</a><ul class="notonly"><li>

            <a href="http://localhost/phpmyadmin/server_engines.php" class="tab">
            <img src="./fit_gym_files/dot.gif" title="Engines" alt="Engines" class="icon ic_b_engine">&nbsp;Engines
            </a>
        </li><li>

            <a href="http://localhost/phpmyadmin/server_plugins.php" class="tab">
            <img src="./fit_gym_files/dot.gif" title="Plugins" alt="Plugins" class="icon ic_b_plugin">&nbsp;Plugins
            </a>
        </li></ul></li><div class="clearfloat"></div></ul></div>
<i class="scrollindicator scrollindicator--right"><img alt="" title="" src="./fit_gym_files/dot.gif" class="icon ic_b_right"></i></div>
</div>

    <span id="page_nav_icons">
      <span id="lock_page_icon"></span>
      <span id="page_settings_icon" style="display: none;">
        <img src="./fit_gym_files/dot.gif" title="Page-related settings" alt="Page-related settings" class="icon ic_s_cog">
      </span>
      <a id="goto_pagetop" href="http://localhost/phpmyadmin/server_databases.php#"><img src="./fit_gym_files/dot.gif" title="Click on the bar to scroll to top of page" alt="Click on the bar to scroll to top of page" class="icon ic_s_top"></a>
    </span>
  ...
  <div id="pma_console_container">
    <div id="pma_console" style="margin-left: 243px;">
            ...
            <img src="./fit_gym_files/dot.gif" title="SQL Query Console" alt="SQL Query Console" class="icon ic_console">
            <span>Console</span>
        </div>
    ...
    <span>No bookmarks</span>
            ...
            <span>Add bookmark</span>
                    ...
                    <div class="content add_bookmark" style="height: 101px;">
                        ...
                        <div class="query_input">
                            <span class="bookmark_add_input"><div class="CodeMirror cm-s-pma CodeMirror-wrap"><div style="overflow: hidden; position: relative; width: 3px; height: 0px; top: 0px; left: 16px;"><textarea autocorrect="off" autocapitalize="off" spellcheck="false" tabindex="0" style="position: absolute; bottom: -1em; padding: 0px; width: 1000px; height: 1em; outline: none;"></textarea></div><div class="CodeMirror-vscrollbar" tabindex="-1" cm-not-content="true"><div style="min-width: 1px; height: 0px;"></div></div><div class="CodeMirror-hscrollbar" tabindex="-1" cm-not-content="true"><div style="height: 100%; min-height: 1px; width: 0px;"></div></div><div class="CodeMirror-scrollbar-filler" cm-not-content="true"></div><div class="CodeMirror-gutter-filler" cm-not-content="true"></div><div class="CodeMirror-scroll" tabindex="-1"><div class="CodeMirror-sizer" style="margin-left: 16px; margin-bottom: -17px; border-right-width: 13px; min-height: 19px; padding-right: 0px; padding-bottom: 0px;"><div style="position: relative; top: 0px;"><div class="CodeMirror-lines" role="presentation"><div role="presentation" style="position: relative; outline: none;"><div class="CodeMirror-measure"><pre class="CodeMirror-line-like"><span>xxxxxxxxxx</span></pre></div><div class="CodeMirror-measure"></div><div style="position: relative; z-index: 1;"></div><div class="CodeMirror-cursors"><div class="CodeMirror-cursor" style="left: 0px; top: 0px; height: 19px;">&nbsp;</div></div><div class="CodeMirror-code" role="presentation"><pre class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;"><span cm-text="">​</span></span></pre></div></div></div></div></div><div style="position: absolute; height: 13px; width: 1px; border-bottom: 0px solid transparent; top: 19px;"></div><div class="CodeMirror-gutters" style="height: 32px;"><div class="CodeMirror-gutter CodeMirror-lint-markers"></div></div></div></div></span>
                        </div>
                    </div>
...
<h2>
  <img src="./fit_gym_files/dot.gif" title="" alt="" class="icon ic_s_db">
      Databases  </h2>

  <ul>
    <li id="li_create_database" class="no_bullets">
              <form method="post" action="http://localhost/phpmyadmin/server_databases.php" id="create_database_form" class="ajax">
          <p>
            <strong>
              <label for="text_create_db">
                <img src="./fit_gym_files/dot.gif" title="" alt="" class="icon ic_b_newdb">
                Create database              </label>
              <a href="http://localhost/phpmyadmin/url.php?url=https%3A%2F%2Fdev.mysql.com%2Fdoc%2Frefman%2F5.7%2Fen%2Fcreate-database.html" target="mysql_doc"><img src="./fit_gym_files/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
            </strong>
          </p>
          ...
          <input type="text" name="new_db" maxlength="64" class="textfield" value="" id="text_create_db" placeholder="Database name" required="">
  ...
  <div id="tableslistcontainer">
    ...
    <form class="ajax" action="http://localhost/phpmyadmin/server_databases.php" method="post" name="dbStatsForm" id="dbStatsForm">
      <input type="hidden" name="statistics" value=""><input type="hidden" name="pos" value="0"><input type="hidden" name="sort_by" value="SCHEMA_NAME"><input type="hidden" name="sort_order" value="asc"><input type="hidden" name="token" value="7e525c2f52724971472a556e3e27375f">
        ...
        <table id="tabledatabases" class="data">
          <thead>
            <tr>
                              <th></th>
                            <th>
                <a href="http://localhost/phpmyadmin/server_databases.php?statistics=0&amp;pos=0&amp;sort_by=SCHEMA_NAME&amp;sort_order=desc">
                  Database                                                            <img src="./fit_gym_files/dot.gif" title="Ascending" alt="Ascending" class="icon ic_s_asc">
                                                      </a>
              </th>

              <th>
                <a href="http://localhost/phpmyadmin/server_databases.php?statistics=0&amp;pos=0&amp;sort_by=DEFAULT_COLLATION_NAME&amp;sort_order=asc">
                  Collation                                  </a>
              </th>
          ...
          <tbody>
                          <tr class="db-row marked" data-filter-row="FIT_GYM">
                                  <td class="tool">
                    <input type="checkbox" name="selected_dbs[]" class="checkall" title="fit_gym" value="fit_gym">
                  </td>
                
                <td class="name">
                  <a href="http://localhost/phpmyadmin/db_structure.php?db=fit_gym" title="Jump to database &#39;fit_gym&#39;">
                    fit_gym
                  </a>
                </td>

                <td class="value">
                  <dfn title="Unicode, binary">
                    utf8_bin
                  </dfn>
                </td>
                ...
                <td class="tool">
                  <a class="server_databases" data="`fit_gym`" href="http://localhost/phpmyadmin/server_privileges.php?db=fit_gym&amp;checkprivsdb=fit_gym" title="Check privileges for database &quot;fit_gym&quot;.">
                    <span class="nowrap"><img src="./fit_gym_files/dot.gif" title="Check privileges" alt="Check privileges" class="icon ic_s_rights">&nbsp;Check privileges</span>
                  </a>
                </td>
              </tr>
                          <tr class="db-row noclick" data-filter-row="INFORMATION_SCHEMA">
                                  <td class="tool">
                    <input type="checkbox" name="selected_dbs[]" class="checkall" title="information_schema" value="information_schema" disabled="">
                  </td>
                
                <td class="name">
                  <a href="http://localhost/phpmyadmin/db_structure.php?db=information_schema" title="Jump to database &#39;information_schema&#39;">
                    information_schema
                  </a>
                </td>
                ...
                <td class="tool">
                  <a class="server_databases" data="`information_schema`" href="http://localhost/phpmyadmin/server_privileges.php?db=information_schema&amp;checkprivsdb=information_schema" title="Check privileges for database &quot;information_schema&quot;.">
                    <span class="nowrap"><img src="./fit_gym_files/dot.gif" title="Check privileges" alt="Check privileges" class="icon ic_s_rights">&nbsp;Check privileges</span>
                  </a>
                </td>
              </tr>
                          <tr class="db-row" data-filter-row="LOGINSYSTEM">
                                  <td class="tool">
                    <input type="checkbox" name="selected_dbs[]" class="checkall" title="loginsystem" value="loginsystem">
                  </td>
                
                <td class="name">
                  <a href="http://localhost/phpmyadmin/db_structure.php?db=loginsystem" title="Jump to database &#39;loginsystem&#39;">
                    loginsystem
                  </a>
                </td>
                ...
                <td class="tool">
                  <a class="server_databases" data="`loginsystem`" href="http://localhost/phpmyadmin/server_privileges.php?db=loginsystem&amp;checkprivsdb=loginsystem" title="Check privileges for database &quot;loginsystem&quot;.">
                    <span class="nowrap"><img src="./fit_gym_files/dot.gif" title="Check privileges" alt="Check privileges" class="icon ic_s_rights">&nbsp;Check privileges</span>
                  </a>
                </td>
              </tr>
                          <tr class="db-row noclick" data-filter-row="MYSQL">
                                  <td class="tool">
                    <input type="checkbox" name="selected_dbs[]" class="checkall" title="mysql" value="mysql" disabled="">
                  </td>
                
                <td class="name">
                  <a href="http://localhost/phpmyadmin/db_structure.php?db=mysql" title="Jump to database &#39;mysql&#39;">
                    mysql
                  </a>
                </td>
                ...
                <td class="tool">
                  <a class="server_databases" data="`mysql`" href="http://localhost/phpmyadmin/server_privileges.php?db=mysql&amp;checkprivsdb=mysql" title="Check privileges for database &quot;mysql&quot;.">
                    <span class="nowrap"><img src="./fit_gym_files/dot.gif" title="Check privileges" alt="Check privileges" class="icon ic_s_rights">&nbsp;Check privileges</span>
                  </a>
                </td>
              </tr>
                          <tr class="db-row" data-filter-row="OSMS_DB">
                                  <td class="tool">
                    <input type="checkbox" name="selected_dbs[]" class="checkall" title="osms_db" value="osms_db">
                  </td>
                
                <td class="name">
                  <a href="http://localhost/phpmyadmin/db_structure.php?db=osms_db" title="Jump to database &#39;osms_db&#39;">
                    osms_db
                  </a>
                </td>
                ...
                <td class="tool">
                  <a class="server_databases" data="`osms_db`" href="http://localhost/phpmyadmin/server_privileges.php?db=osms_db&amp;checkprivsdb=osms_db" title="Check privileges for database &quot;osms_db&quot;.">
                    <span class="nowrap"><img src="./fit_gym_files/dot.gif" title="Check privileges" alt="Check privileges" class="icon ic_s_rights">&nbsp;Check privileges</span>
                  </a>
                </td>
              </tr>
                ...
                <td class="name">
                  <a href="http://localhost/phpmyadmin/db_structure.php?db=performance_schema" title="Jump to database &#39;performance_schema&#39;">
                    performance_schema
                  </a>
                </td>
                ...
                <td class="tool">
                  <a class="server_databases" data="`performance_schema`" href="http://localhost/phpmyadmin/server_privileges.php?db=performance_schema&amp;checkprivsdb=performance_schema" title="Check privileges for database &quot;performance_schema&quot;.">
                    <span class="nowrap"><img src="./fit_gym_files/dot.gif" title="Check privileges" alt="Check privileges" class="icon ic_s_rights">&nbsp;Check privileges</span>
                  </a>
                </td>
              </tr>
                          <tr class="db-row" data-filter-row="PHPMYADMIN">
                                  <td class="tool">
                    <input type="checkbox" name="selected_dbs[]" class="checkall" title="phpmyadmin" value="phpmyadmin">
                  </td>
                
                <td class="name">
                  <a href="http://localhost/phpmyadmin/db_structure.php?db=phpmyadmin" title="Jump to database &#39;phpmyadmin&#39;">
                    phpmyadmin
                  </a>
                </td>
                ...
                <td class="tool">
                  <a class="server_databases" data="`phpmyadmin`" href="http://localhost/phpmyadmin/server_privileges.php?db=phpmyadmin&amp;checkprivsdb=phpmyadmin" title="Check privileges for database &quot;phpmyadmin&quot;.">
                    <span class="nowrap"><img src="./fit_gym_files/dot.gif" title="Check privileges" alt="Check privileges" class="icon ic_s_rights">&nbsp;Check privileges</span>
                  </a>
                </td>
              </tr>
                ...
                <td class="name">
                  <a href="http://localhost/phpmyadmin/db_structure.php?db=test" title="Jump to database &#39;test&#39;">
                    test
                  </a>
                </td>

                <td class="value">
                  <dfn title="Swedish, case-insensitive">
                    latin1_swedish_ci
                  </dfn>
                </td>
                ...
                <td class="tool">
                  <a class="server_databases" data="`test`" href="http://localhost/phpmyadmin/server_privileges.php?db=test&amp;checkprivsdb=test" title="Check privileges for database &quot;test&quot;.">
                    <span class="nowrap"><img src="./fit_gym_files/dot.gif" title="Check privileges" alt="Check privileges" class="icon ic_s_rights">&nbsp;Check privileges</span>
                  </a>
                </td>
              </tr>
          ...
          <tfoot>
            <tr>
              <th colspan="3">
                Total:                <span id="filter-rows-count">8</span>
              </th>
              ...
              <th></th>
                    ...
                    <img class="selectallarrow" src="./fit_gym_files/arrow_ltr.png" width="38" height="22" alt="With selected:">
...
<em class="with-selected">With selected:</em>
        ...
        <button class="btn btn-link mult_submit ajax" type="submit" name="" value="Drop" title="Drop">
<span class="nowrap"><img src="./fit_gym_files/dot.gif" title="Drop" alt="Drop" class="icon ic_b_deltbl">&nbsp;Drop</span></button>

      
                    <div class="notice"><img src="./fit_gym_files/dot.gif" title="" alt="" class="icon ic_s_notice"> Note: Enabling the database statistics here might cause heavy traffic between the web server and the MySQL server.</div>
        <ul>
          <li class="li_switch_dbstats">
            <a href="http://localhost/phpmyadmin/server_databases.php" data-post="statistics=1" title="Enable statistics">
  ...
  <div id="selflink" class="print_ignore"><a href="http://localhost/phpmyadmin/server_databases.php?db=&amp;table=&amp;server=1&amp;target=" title="Open new phpMyAdmin window" target="_blank" rel="noopener noreferrer"><img src="./fit_gym_files/dot.gif" title="Open new phpMyAdmin window" alt="Open new phpMyAdmin window" class="icon ic_window-new"></a></div>
